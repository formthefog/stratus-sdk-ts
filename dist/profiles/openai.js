...
exports.OPENAI_ULTRA_COMPRESSION = exports.OPENAI_HIGH_COMPRESSION = exports.OPENAI_BALANCED = exports.OPENAI_HIGH_QUALITY = void 0;
exports.getOpenAIProfile = getOpenAIProfile;
exports.isOpenAIEmbedding = isOpenAIEmbedding;
exports.detectOpenAI = detectOpenAI;
 ...
 */
exports.OPENAI_HIGH_COMPRESSION = {
    dimensions: 1536,
 ...
 */
exports.OPENAI_ULTRA_COMPRESSION = {
    dimensions: 1536,
 ...
 */
function getOpenAIProfile(level) {
    switch (level) {
        case types_js_1.CompressionLevel.Low:
            return exports.OPENAI_HIGH_QUALITY;
        case types_js_1.CompressionLevel.Medium:
            return exports.OPENAI_BALANCED;
        case types_js_1.CompressionLevel.High:
            return exports.OPENAI_HIGH_COMPRESSION;
        case types_js_1.CompressionLevel.VeryHigh:
            return exports.OPENAI_ULTRA_COMPRESSION;
        default:
            return exports.OPENAI_BALANCED;
    }
}
 ...
 */
function isOpenAIEmbedding(embedding) {
 ...
 */
function detectOpenAI(embedding) {
