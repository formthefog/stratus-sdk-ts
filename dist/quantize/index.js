...
exports.getPrecisionMap = getPrecisionMap;
exports.quantize = quantize;
exports.dequantize = dequantize;
exports.computeCentroid = computeCentroid;
exports.getDefaultCentroid = getDefaultCentroid;
exports.applyDelta = applyDelta;
exports.reverseDelta = reverseDelta;
const math_js_1 = require("../utils/math.js");
const types_js_1 = require("../types.js");
/**
 * Get precision map for given compression level and dimensions
 */
function getPrecisionMap(dimensions, level) {
    const map = new Uint8Array(dimensions);
    switch (level) {
        case types_js_1.CompressionLevel.Low: // 5x compression
            // All 8-bit for maximum quality
            map.fill(8);
            break;
        case types_js_1.CompressionLevel.Medium: // 10x compression
            ...
            break;
        case types_js_1.CompressionLevel.High: // 15x compression
            ...
            break;
        case types_js_1.CompressionLevel.VeryHigh: // 20x compression
            // All 4-bit
            map.fill(4);
            break;
    }
 ...
 */
function quantize(normalized, precisionMap) {
    ...
    for (let i = 0; i < normalized.length; i++) {
        ...
        quantized[i] = (0, math_js_1.clamp)(quantizedValue, 0, levels);
    }
    return quantized;
}
/**
 ...
 */
function dequantize(quantized, precisionMap) {
 ...
 */
function reverseDelta(normalized, scale, centroid) {
